...
## Pagination
- Not implemented. The dataset is 100 posts, which is manageable without pagination. For a larger dataset, offset-based or cursor-based pagination would be added to the GET /api/v1/posts endpoint.
